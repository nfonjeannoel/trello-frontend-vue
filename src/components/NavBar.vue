...
<template>
    ...
    <div class="container py-0 mb-5 px-0 px-lg-5">

        <nav class="navbar navbar-expand-lg bg-body-tertiary rounded-0 py-3 my-0 py-lg-0 fixed-top px-0 px-lg-5"
            ...
            <div class="container-fluid px-5">
                <RouterLink class="navbar-brand" to="/">
                    <svg aria-label="Atlassian Trello" height="37.5" role="img" viewBox="0 0 312 105"
                        ...
                        <linearGradient id="trello-logo-gradient-defaultMJFtCCgVhXrVl7v9HA7EH" x1="49.992%" x2="49.992%"
                            y1="100%" y2=".016%">
                ...
                <div v-if="user ? true : false" class="collapse navbar-collapse" id="navbarsExample09">
                    <ul class="me-auto mb-2 mb-lg-0">

                    </ul>
                    <div class="d-lg-flex col-sm-12 col-lg-auto justify-content-lg-end">
                        <RouterLink to="/boards" class="btn btn-primary btn-lg rounded-0 my-0 px-4 py-3 w-100 ">View my
                            boards</RouterLink>
                    </div>
